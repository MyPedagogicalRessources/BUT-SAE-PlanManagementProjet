...
Équipe pédagogique BUT Informatique de Rodez
v2024-01
:title-page: true
...
définition des exigences produit.
    ...
    GEN003 : La durée des sprints (hors sprint 0) devrait être de 3 semaines et ne doit en aucun cas excéder les 4 semaines. Faire un diagramme prévisionnel GANTT avec les périodes des sprints qui seront planifiés. Lors de livraison des documents gestion de projets, livrer le GANTT prévisionnel et le GANTT final.
...
=== Les rôles dans l'équipe
    ...
    ROL004: Les rôles de Product Owner et de Scrum Master doivent changer au cours du projet.
...
Quand un item du backlog a été réalisé dans le produit (on parle d'item "fini" dans Scrum), l'item est alors sorti du backlog.
    ...
    EXI003: Les User stories doivent respecter le format "En tant que… Je veux… De telle sorte que…". 
...
=== Github Project
    ...
    GPRO001 : Github Project doit être utilisé pour la gestion du backlog. 

Afin de suivre l'évolution du travail pendant un sprint, on utilise un tableau (board agile ou kanban) permettant d'indiquer visuellement le changement d'état des items du backlog. Github Project permet aussi de gérer le board agile. 

    GPRO002 : Github Project doit être utilisé pour la gestion du board agile.
...
=== Google Drive
    ...
    Nom du dossier  : SAE <N° ou code du projet>  - Intitulé du projet de la SAE - S <N° semestre> .
...
- Le board agile géré via Github Project. 
...
=== Suivi des temps individuels
    ...
    - Temps totalisé par étudiant, par type d'activité, par sprint et global sur le semestre avec graphiques.

=== Les comptes-rendus de réunions

    CR001: Chaque réunion fait l'objet d'un compte-rendu à fournir (nommer les documents avec leur type + date). Chaque type de réunion aura un "template" différent puisque les contenus sont différents.
